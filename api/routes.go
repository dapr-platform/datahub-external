...
func InitRoute(r *chi.Mux) {
	...
	r.Route("/ps", func(r chi.Router) {
		...
		r.Get("/positions-inc", psController.GetPositionsInc)
		r.Get("/positions-all", psController.GetPositionsAll)
		r.Get("/organizations-inc", psController.GetOrganizationsInc)
		r.Get("/organizations-all", psController.GetOrganizationsAll)
		r.Get("/employees-inc", psController.GetEmployeesInc)
		r.Get("/employees-all", psController.GetEmployeesAll)
		r.Get("/employee-honors", psController.GetEmployeeHonors)
		r.Get("/family-main", psController.GetFamilyMain)
